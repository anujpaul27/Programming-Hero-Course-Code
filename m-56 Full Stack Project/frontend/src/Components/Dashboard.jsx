...
const roles = [
  ...
  { id: "recruiter", label: "Recruiter", icon: BriefcaseIcon, color: "emerald" },
];
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { label: "Total Users", value: "12,458", icon: UsersIcon, change: "+12%" },
                { label: "Active Jobs", value: "843", icon: BriefcaseIcon, change: "+5%" },
                { label: "Applications", value: "3,291", icon: ChartBarIcon, change: "-2%" },
                { label: "Companies", value: "427", icon: UserGroupIcon, change: "+18%" },
              ].map((stat, i) => (
                <motion.div
                  key={i}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {["Frontend Developer", "Product Designer", "Software Engineer", "Marketing Manager"].map((job, i) => (
                ...
                >
                  ...
                  <button className="mt-6 btn btn-primary rounded-full px-8">Apply Now</button>
                </motion.div>
              ))}
            </div>
          </div>
