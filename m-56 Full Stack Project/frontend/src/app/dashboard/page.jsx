...
const Dashboard = () => {
  ...
  const Icons = {
    ...
    Briefcase: () => (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 13V6a2 2 0 00-2-2H5a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5m16 0h-4a2 2 0 01-2-2v-1a2 2 0 00-2-2H9a2 2 0 00-2 2v1a2 2 0 01-2 2H3" />
      </svg>
    ),
    ChartBar: () => (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    Bell: () => (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 00-9-5.197V8.5m.002 3.5L12 15l-1.998-3.5" />
      </svg>
    ),
    Search: () => (
  ...
  const getRoleContent = () => {
    switch (activeRole) {
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { label: "Total Users", value: "12,458", icon: Icons.Users, change: "+12%" },
                { label: "Active Jobs", value: "843", icon: Icons.Briefcase, change: "+5%" },
                { label: "Applications", value: "3,291", icon: Icons.ChartBar, change: "-2%" },
                { label: "Companies", value: "427", icon: Icons.UserGroup, change: "+18%" },
              ].map((stat, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <h3 className="text-4xl font-bold text-white mt-6">{stat.value}</h3>
            ...
            <div className="bg-gray-800 rounded-3xl p-8">
              ...
              <div className="space-y-4">
                {[1,2,3,4].map((_, i) => (
                  <div key={i} className="flex items-center gap-4 bg-gray-900 p-4 rounded-2xl">
      ...
      case "seeker":
        return (
          <div className="space-y-8">
            <h1 className="text-4xl font-bold text-white">Job Seeker Dashboard</h1>
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-10 text-white">
              ...
              <p className="mt-2 opacity-90">Based on your profile and preferences</p>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {["Frontend Developer", "Product Designer", "Software Engineer", "Marketing Manager"].map((job, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <p className="text-gray-400 mt-2">TechCorp • Remote • $85k - $110k</p>
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="bg-gray-800 rounded-3xl p-8">
              ...
              <div className="space-y-4">
                {["Sarah Chen", "Michael Torres", "Priya Sharma"].map((name, i) => (
                  <div key={i} className="flex items-center justify-between bg-gray-900 p-5 rounded-2xl">
      ...
      >
        <div className="p-6 flex items-center gap-3 border-b border-gray-800">
          ...
          <motion.span
            ...
            className="text-2xl font-bold text-pink-400 whitespace-nowrap"
          >
            LinkUp
          </motion.span>
        </div>
        ...
        <div className="p-4 flex flex-col gap-1">
          {[
            { id: "admin", label: "Admin", icon: Icons.Cog, color: "rose" },
            { id: "seeker", label: "Job Seeker", icon: Icons.UserCircle, color: "blue" },
            { id: "recruiter", label: "Recruiter", icon: Icons.Briefcase, color: "emerald" },
          ].map((role) => (
            <button
              key={role.id}
      ...
      <div className="flex-1 flex flex-col overflow-auto">
        <nav className="bg-gray-900 border-b border-gray-800 px-8 py-4 flex items-center justify-between sticky top-0 z-50">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-semibold capitalize">{activeRole} Dashboard</h2>
          </div>
          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              ...
              />
              <Icons.Search className="absolute left-3.5 top-3.5 text-gray-500" />
            </div>
