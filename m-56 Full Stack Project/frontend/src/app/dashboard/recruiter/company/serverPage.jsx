...
export default function MyCompany({user,cmp}) {
  // Simulate data state (In real app, fetch this data in useEffect from GET API)
  const [company, setCompany] = useState(cmp); 
  ...
  const handleCreateCompany = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/company/create`, {
        method: "POST",
